...
def detectDataSet(args):
  ...
  # prediction_column_df = pandas.DataFrame(emptyRow, columns=['prediction'])
  # prediction_column_df.to_csv(outputPath, index=False)
  # with open(outputPath, 'a') as f:
  #   prediction_column_df.to_csv(f, header=False)
  #   f.close()
  #prediction_column_df.to_csv(outputPath, header=False, mode = 'a')
  #prediction_column_df.to_csv(outputPath, mode='a', index=False)
